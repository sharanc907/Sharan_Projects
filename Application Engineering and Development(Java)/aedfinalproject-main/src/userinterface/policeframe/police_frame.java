 ...
 */
package userinterface.policeframe;
...
public class police_frame extends javax.swing.JPanel {
    ...
    /**
     * Creates new form police_frame
     */
    public police_frame(JPanel container,EcoSystem system,UserAccount userAccount) {
        initComponents();
        this.container=container;
        this.system=system;
        this.userAccount=userAccount;
        PoliceDepartment p=(PoliceDepartment)userAccount;
        jLabel4.setText(p.getName()+" Welcome!!");
        populate_table();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int u=ol.size();
        PoliceDepartment a=(PoliceDepartment)userAccount;
        for(int i=0;i<u;i++)
        {
