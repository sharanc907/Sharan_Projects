 ...
 * @author raksh
 */
public class Vaccination_org extends javax.swing.JPanel {
     ...
     */
    public Vaccination_org(JPanel container,EcoSystem system) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        vaccination_org_directory bbd = ecosystem.getVacc_org();
        ArrayList<vaccination_org> cd1=bbd.getA();
        int z=cd1.size();
        for(int i=0;i<z;i++)
        {
            vaccination_org c=cd1.get(i);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(ecosystem.getUserAccountDirectory().checkIfUsernameIsUnique(jTextField4.getText())){
            if(!jTextField2.getText().matches("[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]"))
            {
            ...
            vaccination_org customer = new vaccination_org(jTextField1.getText(),  jTextField4.getText(),jTextField5.getText(),jTextField2.getText(), jTextField3.getText() );
            ecosystem.getUserAccountDirectory().addAccount(customer);
            ecosystem.getVacc_org().addvacc_org(customer);
            populateTable();
            jTextField1.setText("");
            jTextField2.setText("");
            jTextField3.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for(int i=0;i<z;i++)
        {
                ...
                if(!jTextField2.getText().matches("[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]"))
            {
                ...
                c.setPhonenumber(jTextField2.getText());
                c.setLocation(jTextField3.getText());
    ...
    private void populateTable() {
        ...
        model.setRowCount(0);
        for (vaccination_org customer : bbd.getA()) {
                    Object[] row = new Object[5];
                    row[0] = customer.getName();
                    row[1] = customer.getPhonenumber();
                    row[2] = customer.getLocation();
